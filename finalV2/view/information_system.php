...
<html>
	...
	<article>
		<article>
			...
			Pour cela, nous utilisons une LED.<br/>
			 La LED que nous exploitons agit comme un rayon qui traverse le doigt, en le traversant, cette LED va permettre de déterminer la fluctuation du sang et ainsi connaitre le rythme cardiaque.
			<br/>
	...
	<section>
		<article>
			<h3>Test de réflexes visuel
			</h3>
			<p>
				Nous utilisons un test qui fait appel aux réflexes visuels, nous allumons des lampes, le candidat doit réagir à chaque fois qu'une ampoule s'allume.
			</p>
		</article>
	</section>
	</div>
