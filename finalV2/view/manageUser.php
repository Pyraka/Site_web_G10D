...
require ("../controller/functions.php");
 ...
 elseif(isset($_GET['promouvoir'])){
        
    $promouvoir = (int) $_GET['promouvoir'];
    $req = $bdd->prepare('UPDATE user SET allow = 2 WHERE idUser = ?');
    $req->execute(array($promouvoir));
...
<body>
        ...
        <br></br>
            ...
            if (isban($m['idUser'])){
                ...
                - <a class="editAdmin" href="manageUser.php?promouvoir=<?= $m['idUser'] ?>">Promouvoir</a>
                <?php
            }
            ?>
