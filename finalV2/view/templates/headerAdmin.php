					...
					<nav role="navigation" class="menu">
						...
						<ul class="inline" id="menuPrincipal">
							...
							<li>
								...
								<span class="centerLogo">Gérer les utilisateurs</span></a>
							</li>
							<li>
								<a href="manageKey.php">
								<img src="images/logoSystem.png" class="logoMenu" />
								<span class="centerLogo">Gérer les clés produit</span></a>
							</li>
							<li>
								<a href="faq.php">
						...
						<ul class="inline" id="menuAuthentification">
							<a href="../view/public/connect.php"><li id="connect">Se connecter</li></a>
							<a href="../view/public/create.php"><li id="inscription">S'inscrire</li></a>
						</ul>
						<?php } ?>
					</nav>
				</div>
