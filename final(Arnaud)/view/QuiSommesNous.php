	...
	<div class="underline"></div>
			<section>
				...
				<p id="PresentationMedisys">Médi-sys est une jeune startup fondée en 2018 par un groupe
					...
					hopitaux de Paris sur la réalisation de capteurs mesurant la fréquence cardiaque. Cette nouvelle 
					entreprise a eu la chance de se développer et de travaiiler avec un nouveau client, Infinite Mesures, 
